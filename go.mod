module github.com/yimi-go/serve-grpc
...
require (
	...
	github.com/yimi-go/afr-rate-limiter v0.0.2
	github.com/yimi-go/errors v0.0.2
...
require (
	...
	github.com/yimi-go/keeper v0.0.2 // indirect
	github.com/yimi-go/window v0.0.6 // indirect
